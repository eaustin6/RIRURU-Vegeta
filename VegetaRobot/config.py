...
class Config(object):
    ...
    TOKEN = "5086199001:AAHyhuELuaiZo7nbLAMRSFHb4dfUsbb0zPI"  #This var used to be API_KEY but it is now TOKEN, adjust accordingly.
    ...
    CASH_API_KEY = 'LK53RBG7R1WU80RY'  # Get your API key from https://www.alphavantage.co/support/#api-key
